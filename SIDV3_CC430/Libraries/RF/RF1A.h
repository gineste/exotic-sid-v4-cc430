...
typedef struct {
    ...
    uint8_t rf1ainstr1w;   // Radio instruction word register with 1-byte auto-r..
    uint8_t rf1ainstr2w;   // Radio instruction word register with 2-byte auto-r..
    ...
    uint8_t rf1adout0w;    // Radio core word data out register without auto-rea..
    uint8_t rf1adout1w;    // Radio core word data out register with 1-byte auto..
    uint8_t rf1adout2w;    // Radio core word data out register with 2-byte auto..
