...
(____)(_/\_) \__/  (__)  (__)  \___)  (____/(__/  (____/ (__) (____)\_)(_/(____/
  ...
  File name:    lib_ExoDefs.h
  Date:         02 01 2018
  Author:       Emeric L.
  Description:  Definitions library - Header file.
============================================================================= */
#ifndef LIB_EXODEFS__H
  #define LIB_EXODEFS__H
